...
const Layout = () => {
    ...
    const noPadding = location.pathname === '/notices' || location.pathname === '/mypage' || location.pathname === '/faq';
...
const NotificationBadge = styled.span`
    ...
    color: white;
    border-radius: 10px;
    width: ${props => props.children && props.children.toString().length > 1 ? '20px' : '8px'};
    height: ${props => props.children && props.children.toString().length > 1 ? '16px' : '8px'};
    display: flex;
    align-items: center;
    justify-content: center;
    font-size: 10px;
    font-weight: bold;
    min-width: 16px;
    padding: ${props => props.children && props.children.toString().length > 1 ? '0 2px' : '0'};
`;
