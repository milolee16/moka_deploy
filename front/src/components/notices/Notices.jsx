...
const NoticesPage = () => {
    ...
    // TODO: 실제 앱에서는 로그인된 사용자 정보에서 역할(role)을 가져와야 합니다.
    const isAdmin = true;
                            ...
                            editingId === notice.id ? (
                                ...
                                <EditContainer>
                                    ...
                                    <AdminActions>
                                        ...
                                        <ActionButton onClick={() => handleUpdateSubmit(notice)}>확인</ActionButton>
                                    </AdminActions>
                                </EditContainer>
                            ) : (
                                // 일반 보기 모드 UI
                                <>
                                    ...
                                    {isAdmin && (
                                        <AdminActions>
                                            <ActionButton onClick={() => handleEditClick(notice)}>수정</ActionButton>
                                            <ActionButton onClick={() => handleDelete(notice.id)}>삭제</ActionButton>
                                        </AdminActions>
                                    )}
                                </>
                            )
